...
public interface ReadAppointmentsByPatientAndDateCase {
    List<AppointmentHistoryResponse> getByPatientAndDateCase(String patientId, LocalDate start, LocalDate end, String authToken);
}
